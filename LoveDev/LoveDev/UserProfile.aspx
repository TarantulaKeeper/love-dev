            ...
            <div class="row padtop">
                <div class="col-lg-3 col-md-4 col-sm-5 col-xs-6">
                    ...
                    <div class="panel panel-collapse">
                        <span class="h5">Select a Profile Photo.</span>
                        <asp:ImageButton ImageUrl="/Images/EditIcon.png" ID="imgbtnEditProfilePhoto" runat="server" CssClass="btn btn-warning right" OnClick="imgbtnEditProfilePhoto_Click" />
                    ...
                    <div class="panel">
                        <asp:Panel ID="pnlBasicInformation" runat="server" CssClass="">
                            <div class="">
                                ...
                                <a class="btn btn-warning right"><asp:ImageButton ImageUrl="/Images/EditIcon.png" ID="imgbtnEditBasicInfo" OnClick="imgbtnEditBasicInfo_Click" runat="server" /></a>
